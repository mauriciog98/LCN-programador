<template>
    <div class="card p-3">
        <h3 class="text-center">{{ $t('editStudent') }}</h3>
        <div class="row justify-content-md-center">
            <div class="col-md-6">
                <form @submit.prevent="updateStudent">
                    ...
                    <br>
                    <button type="submit" class="btn btn-primary">{{ $t('updateStudent') }}</button>
...
export default {
    ...
    created() {
        this.axios
            .get(`http://localhost:8000/api/student/show/${this.$route.params.id}`)
            .then((response) => {
